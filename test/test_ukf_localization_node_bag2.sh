...
cmd3="source /opt/ros/melodic/setup.bash; rosparam set use_sim_time true; rosbag play ~/rl_ws_crystal/src/robot_localization/test/test2.bag --clock -d 5; exec /bin/bash"

#Command to launch TestCase launch.py
cmd4="source ~/rl_ws_crystal/install/setup.bash; ros2 launch robot_localization test_ukf_localization_node_bag2.launch.py; exec /bin/bash"
