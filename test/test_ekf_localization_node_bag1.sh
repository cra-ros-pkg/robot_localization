...
cmd4="source /opt/ros/bouncy/setup.bash; source ~/rl_ws/install/setup.bash; ros2 launch robot_localization test_ekf_localization_node_bag1.launch.py; exec /bin/bash"
